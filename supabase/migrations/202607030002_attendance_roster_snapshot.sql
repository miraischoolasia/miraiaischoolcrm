-- Keep each lesson roster stable across 24-hour attendance revisions.
-- The first submission must include the complete assigned roster. Later revisions
-- use the previous lesson log as the roster snapshot, even after a student moves.
